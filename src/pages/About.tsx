  ...
  return (
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
      <div className="text-center space-y-4 mb-8">
        <h1 className="text-3xl font-bold">RiskAI - Платформа управления рисками</h1>
      ...
      <div className="grid gap-8">
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1">
                ...
                <p className="mb-4">
                  RiskAI – это интеллектуальная платформа, созданная для помощи бизнесу в соблюдении 
              ...
              <div className="md:w-1/3 flex items-center justify-center">
                <div className="h-48 w-48 bg-primary/10 rounded-full flex items-center justify-center">
                  <div className="h-36 w-36 bg-primary/20 rounded-full flex items-center justify-center">
                    <div className="h-24 w-24 bg-primary rounded-full flex items-center justify-center">
                      <span className="text-2xl font-bold text-primary-foreground">RiskAI</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <Tabs defaultValue="features" className="w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <div className="flex items-start">
                      <div className="mr-3 h-8 w-8 rounded-full bg-primary flex items-center justify-center text-primary-foreground">1</div>
                      <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start">
                      <div className="mr-3 h-8 w-8 rounded-full bg-primary flex items-center justify-center text-primary-foreground">2</div>
                      <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start">
                      <div className="mr-3 h-8 w-8 rounded-full bg-primary flex items-center justify-center text-primary-foreground">3</div>
                      <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start">
                      <div className="mr-3 h-8 w-8 rounded-full bg-primary flex items-center justify-center text-primary-foreground">4</div>
                      <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start">
                      <div className="mr-3 h-8 w-8 rounded-full bg-primary flex items-center justify-center text-primary-foreground">5</div>
                      <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start">
                      <div className="mr-3 h-8 w-8 rounded-full bg-primary flex items-center justify-center text-primary-foreground">6</div>
                      <div>
          ...
          <TabsContent value="benefits" className="mt-4">
            <Card>
              <CardContent className="pt-6">
                <h3 className="text-xl font-semibold mb-4">Преимущества использования RiskAI</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-primary/5 p-4 rounded-lg">
                    <h4 className="font-medium text-primary mb-2">Снижение рисков</h4>
                    <p className="text-sm">Своевременное выявление и минимизация рисков несоответствия нормативным требованиям</p>
                  </div>
                  
                  <div className="bg-green-500/10 p-4 rounded-lg">
                    <h4 className="font-medium text-green-700 dark:text-green-400 mb-2">Экономия времени</h4>
                  ...
                  <div className="bg-amber-500/10 p-4 rounded-lg">
                    <h4 className="font-medium text-amber-700 dark:text-amber-400 mb-2">Повышение эффективности</h4>
                    <p className="text-sm">Оптимизация процессов обеспечения соответствия и улучшение взаимодействия между отделами</p>
                  </div>
                  
                  <div className="bg-blue-500/10 p-4 rounded-lg">
                    <h4 className="font-medium text-blue-700 dark:text-blue-400 mb-2">Централизация данных</h4>
                  ...
                  <div className="bg-indigo-500/10 p-4 rounded-lg">
                    <h4 className="font-medium text-indigo-700 dark:text-indigo-400 mb-2">Интеллектуальный анализ</h4>
                  ...
                  <div className="bg-red-500/10 p-4 rounded-lg">
                    <h4 className="font-medium text-red-700 dark:text-red-400 mb-2">Избежание штрафов</h4>
